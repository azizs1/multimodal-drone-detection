...
#Datasets are weighted based on frequency so that after weighting each dataset has roughly the same number of images.
#This is done by providing multiple references to the smaller datasets in the training split until the amount of images matches up.
...
def train(args):
    ...
    for experiment in experiments:
        ...
        # Evaluate the best model performance for each experiment on the test set of that experiment.
